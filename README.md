...
| <a name="input_create_serverless_cache"></a> [create\_serverless\_cache](#input\_create\_serverless\_cache) | Determines whether serverless resource will be created | `bool` | `false` | no |
